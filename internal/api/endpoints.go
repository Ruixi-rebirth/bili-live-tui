...
var Endpoints = map[string]Endpoint{
	...
	"GetShieldKeywords":     {Name: "GetShieldKeywords", Method: http.MethodPost, Path: "/xlive/web-ucenter/v1/banned/GetShieldKeywordList", Description: "获取当前账号的弹幕观看屏蔽词"},
	"AddShieldKeyword":      {Name: "AddShieldKeyword", Method: http.MethodPost, Path: "/xlive/web-ucenter/v1/banned/AddShieldKeyword", Description: "添加当前账号的弹幕观看屏蔽词"},
	"DeleteShieldKeyword":   {Name: "DeleteShieldKeyword", Method: http.MethodPost, Path: "/xlive/web-ucenter/v1/banned/DelShieldKeyword", Description: "删除当前账号的弹幕观看屏蔽词"},
